...
#include <VGA.h>
#include <VGALiquidCrystal.h>  //this library is included in the Arduino IDE

//Buttons are defined for Arcade MegaWing
const int buttonPinLeft = 25;      // pin for the Up button
const int buttonPinRight = 26;    // pin for the Down button
const int buttonPinEsc = 24;     // pin for the Esc button
const int buttonPinEnter = 27;   // pin for the Enter button
...
VGALiquidCrystal lcd(2, 3, 4, 5, 6, 7);
...
//                  Serial.print("lastButtonEnterState=");
//                  Serial.println(lastButtonEnterState);
